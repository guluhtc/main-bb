...
export default function Pricing() {
  ...
  return (
    <div className="flex mx-auto max-w-7xl overflow-visible flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>Buy DecorAI Credits</title>
      </Head>
      ...
      <div className="w-full">
        {session?.user?.email && (
          ...
          <stripe-pricing-table
            pricing-table-id="prctbl_1N3wBNCCYa6cAnBn7PK5jw0h"
            publishable-key="pk_live_51HvLo2CCYa6cAnBnU1LidWtK9t92dv2kGF0M7Y6w9gnNE2aVSJxrIwb0NftuXOFqtludtJEHmSoBxd2o7RFoPIPT00lcnx9QPD"
      ...
      <p className="text-gray-400 mb-5">
        ...
        <span className="text-gray-300">decorai.xyz@gmail.com</span>
      </p>
      <Footer />
    </div>
  );
